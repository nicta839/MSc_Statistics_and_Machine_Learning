...
In this exercise we perform 10000 draws from the calculated posterio and compare it with the theoretical scaled inverse chi-square posterior distribution.
```{r, echo=TRUE}
# Data provided
...
We observe that the HDPI is much larger than the equal tails. This is due to a very high mass being present in the tail of the Gini coefficient distribution that skews this measure.
